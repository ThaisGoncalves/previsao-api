...
@Service
public class AutenticacaoWmsServiceImpl implements AutenticacaoWmsService {
	...
	@Override
	public AutenticacaoWmsDTO autenticaWms() throws Exception {
		...
		ResponseEntity<AutenticacaoWmsDTO> response = restTemplate.postForEntity(parametros.getAuthenticationUrl(),
				params, AutenticacaoWmsDTO.class);
